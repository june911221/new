...
<%
	...
	<meta charset="UTF-8">
	<title>index</title>
<link rel="stylesheet" href="./css_hsh1/header.css">
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script>
<script  src="js_hsh1/header.js"></script>

</head>
<body>
	<header>
	<!--메인로고 -->
	<a href="?pageChange=main_hsh1.jsp"><div id="logo"><img src="img_hsh1/logo2.png"></div></a>
...
<!-- 메뉴바&로그인 -->
	...
	<div class="topMenu">
	<ul class="menu01">
		<li><a href="?pageChange=main_hsh1.jsp">Home</a></li>
		<li><a href="#">항공조회</a></li>
		<li><a href="?pageChange=tourinfo_hsh1.jsp">여행정보</a>
			<ul class="dept01">
				<li id="nop"><a href="?pageChange=tourcity_hsh1.jsp">도시</a></li>
		...
		<li><a href="?pageChange=mypage_phy.jsp">마이페이지</a>
	        <ul class="dept01">
				<li id="nop"><a href="?pageChange=">회원정보수정</a></li>
				<li id="nop"><a href="#">예약확인&취소</a></li>
	...
	<!-- user메뉴 -->
	<ul id="user">
	<li class="open-button" onclick="openForm()">로그인</li>
	<div class="form-popup" id="myForm">
  <form action="LoginInput_hsh1.jsp" class="form-container">
	...
	<a href="?pageChange=srcid.jsp" name="srcid" id="srcid">아이디 찾기</a>
	<a href="?pageChange=srcpw.jsp" name="srcpw" id="srcpw"> 비밀번호 찾기</a>
	<a href="?pageChange=signin_hsh1.jsp" name="signin" id="signin"> 회원가입</a>
  </form>
</div>
	
	<a href="?pageChange=signin_hsh1.jsp"><li>회원가입</li></a>
