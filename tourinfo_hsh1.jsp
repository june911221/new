...
<%@ page import="java.sql.*"%>
	...
	<title>index</title>
<link rel="stylesheet" href="css_hsh1/tourinfo.css">
<script  src="js_hsh1/tourinfo.js"></script>
	</head>
	<body>
...
<form name="cnjform">
<select class="sel" name="cityname" id="getWeatherForcast" onChange="changeView();">
