...
<html lang="en">
 <head>
  ...
  <link rel="stylesheet" href="css_hsh1/main.css">
<script  src="js_hsh1/main.js"></script>
...
<div id="sub">
  <ul id="main-menu">
    ...
    <li id="city"><img id="mini" src="img/asi.png" width="55px;" height="45px;"><br><div id="Aname">아시아</div>
      <ul id="sub-menu">
      <div id="citylist">
	    <li id="list2"><a href="#" aria-label="subemnu"><img id="flag" src="img\flag_HKG.gif" width="40" height="25">  홍콩</a></li>
    ...
    <li id="city"><img id="mini" src="img\dong.png" width="55px;" height="45px;"><br><div id="Aname">동남아</div>
      <ul id="sub-menu">
    ...
    <li id="city"><img id="mini" src="img\eu.png" width="55px;" height="45px;"><br><div id="Aname">유럽</div>
      <ul id="sub-menu">
     ...
     <li id="city"><img id="mini" src="img\am.png" width="55px;" height="45px;"><br><div id="Aname">미주</div>
      <ul id="sub-menu">
	...
	<li id="city"><img id="mini" src="img\d.png" width="55px;" height="45px;"><br><div id="Aname">남태평양</div>
      <ul id="sub-menu">
...
<div class="sample_image">
<img id="pic1"src="img\pic1.png">
</div>
<div class="sample_image">
<img id="pic2" src="img\pic2.png">
</div>
<div class="sample_image">
<img id="pic3"src="img\pic3.png">
</div> 
</div>
</section>
   <footer>
   <div class=layout id="end">
   <div id="footlist">제작자 : 박하영, 홍준영, 한상혁<br>
