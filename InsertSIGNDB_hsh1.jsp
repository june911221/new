...
conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/hjy?useSSL=false&useUnicode=true&characterEncoding=utf8","root","911221");
if(conn == null)
	throw new Exception("데이터베이스에 연결할 수 없습니다.<br>");
stmt=conn.createStatement();
String command = String.format("insert into memberlist values"+"('"+name+"','"+gender+"','"+birth+"','"+phone+"','"+email+"','"+addr+"','"+id+"','"+pw+"');");
...
throw new Exception("데이터를 DB에 입력할 수 없습니다."); 
	...
	RequestDispatcher dispatcher=request.getRequestDispatcher("InsertSIGNRead_hsh1.jsp");
