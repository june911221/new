...
<script  src="js_hsh1/Signin.js"></script>
  <style>
  body{
  }
  #sign_box{   
...
<script>
 ...
 <body>
<section>
 <form method="post" action="InsertSIGNDB_hsh1.jsp" name="SIGNIN">
 <div id="sign_box">
  <table align="center">
	  	  <tr>
	  <th colspan="2"><h3>1.로그인 정보</h3></th></tr>
	  <tr>
      <td><font>*</font> 아이디</td>
	  ...
	  <tr>	  
	  <th colspan="2"><h3>2.회원 정보</h3></th></tr>
	  <tr>
      <td><font>*</font> 이름</td>
