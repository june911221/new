...
<!DOCTYPE html>
	...
	<meta charset="UTF-8">
	<title>index</title>
<link rel="stylesheet" href="css_hsh1/Loginheader.css">
<script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script>
<script  src="js_hsh1/Loginheader.js"></script>
	</head>
	<body>
	<header>
	<!--메인로고 -->
	<a href="?pageChange=tourinfo_hsh1.jsp"><div id="logo"><img src="img/logo2.png"></div></a>
...
<!-- 메뉴바&로그인 -->
	...
	<div class="topMenu">
	<ul class="menu01">
		<li><a href="?pageChange=tourinfo_hsh1.jsp">Home</a></li>
		<li><a href="#">항공조회</a></li>
	...
	<!-- user메뉴 -->
	<ul id="user"><a href="headerLogout_hsh1.jsp">로그아웃</a>
	
	<li>${ID}님 &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</li>	
	</ul>
	</div>
	</nav>
	</header>
